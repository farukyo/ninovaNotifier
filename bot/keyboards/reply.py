...
def build_user_menu_keyboard(is_admin: bool = False) -> types.ReplyKeyboardMarkup:
    """
...
def build_extra_features_keyboard() -> types.ReplyKeyboardMarkup:
    """
...
def build_ari24_menu_keyboard(daily_sub_status: bool = False) -> types.ReplyKeyboardMarkup:
    """
...
def build_rehber_ad_keyboard() -> types.ReplyKeyboardMarkup:
...
def build_rehber_soyad_keyboard() -> types.ReplyKeyboardMarkup:
