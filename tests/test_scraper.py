...
class TestGetAnnouncements:
    ...
    def test_parse_announcements_from_html(
        self, mock_session, sample_html_announcements
    ):
...
class TestGetAnnouncementDetail:
    ...
    def test_get_detail_content(self, mock_session):
        ...
        result = get_announcement_detail(
            mock_session, "https://ninova.itu.edu.tr/Duyuru/123"
        )
...
class TestGetAssignmentDetail:
    ...
    def test_parse_assignment_dates(self, mock_session):
        ...
        result = get_assignment_detail(
            mock_session, "https://ninova.itu.edu.tr/Odev/123"
        )
